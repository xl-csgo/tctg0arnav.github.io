...
<form method="post" action="submit.php">
	...
	echo '
	<label style="margin:0;">Name of the Accompanying Teacher</label><br>
	<input class="input" type="text" name="accomp_teach_name" placeholder="Name of the Accompanying Teacher" value='.$atn.' required><br><br>
	<label style="margin:0;">Phone No. of the Accompanying Teacher</label><br>
